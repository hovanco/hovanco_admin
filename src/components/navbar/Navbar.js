    ...
    return (
      <div className="navbar-containner">
        <nav className="navbar-top">
          ...
          <ul>
          {/* <MenuLink label="Login" to="/login" activeOnlyWhenExact={true} /> */}
            ...
            {user ?
              <>
                <MenuLink label="Category" to="/categories" activeOnlyWhenExact={false} />
                <MenuLink label="City" to="/citys" activeOnlyWhenExact={false} />
               ...
               <Link to="/" onClick={this.logOut} className="link-logout">Logout</Link>
